    ...
    <body class="bg-gray-50 flex items-center justify-center min-h-screen p-4">
        <div class="max-w-md w-full bg-white shadow-2xl rounded-3xl p-8 border border-gray-100">
            ...
            <div class="mt-8 space-y-3">
                <button onclick="window.print()" class="w-full bg-white border-2 border-gray-200 hover:border-gray-900 text-gray-900 font-bold py-3 rounded-2xl transition duration-200 flex items-center justify-center gap-2">
